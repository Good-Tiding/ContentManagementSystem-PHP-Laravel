    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <x-admin.topbar.admin-topbar-searching>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <x-admin.topbar.admin-topbar-alerts>
            ...
            <x-admin.topbar.admin-topbar-messages>
            ...
            <x-admin.topbar.admin-topbar-user-info>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; CMS system {{\Carbon\Carbon::now()->year}}</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
